...
public class PuRecycleViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRvPu.setAdapter(new StaggeredGridAdapter(PuRecycleViewActivity.this, new StaggeredGridAdapter.OnItemClickLisener() {
            @Override
    ...
    class MyDecoration extends RecyclerView.ItemDecoration{
        ...
        public void getItemOffsets(@NonNull Rect outRect, @NonNull View view, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
            ...
            int gap = getResources().getDimensionPixelSize(R.dimen.dividerhHeight2);
